      ...
      <div data-aos="fade-down"
        ...
        <div className="left-login">
          ...
          <form onSubmit={handlesubmit} className="below-name mt-5 ml-10">
            ...
            <input onChange={(e) => email.current.value = e.target.value} autoComplete='false' className='bg-gray-200 dark:bg-slate-500 dark:placeholder:text-white' type="text" name="name" id
              ="name" placeholder='Email ' ref={email} />
            <label className='font dark:text-white mt-3' htmlFor="pass ">PASSWORD</label>
            <input onChange={(e) => password.current.value = e.target.value} autoComplete='false' className='bg-gray-200 dark:bg-slate-500 dark:placeholder:text-white' type="password" name="pass" id="pass" placeholder='Password' ref={password} />
