...
export const Review = () => {
  ...
  return (
    <main className=''>
      <h1 data-aos="fade-up" className='text-2xl text-center font-semibold dark:text-slate-100 mb-36 mt-36 underline underline-offset-8 '>Students About Grc Learning</h1>
